package com.train.educate.happysever.net;

import static com.train.educate.happysever.net.ConnectConstants.BROADCAST_EXIT;
import static com.train.educate.happysever.net.ConnectConstants.BROADCAST_JOIN;
import static com.train.educate.happysever.net.ConnectConstants.CHAT_ONE;
import static com.train.educate.happysever.net.ConnectConstants.CONNECT_AGREE;
import static com.train.educate.happysever.net.ConnectConstants.CONNECT_ASK;
import static com.train.educate.happysever.net.ConnectConstants.CONNECT_REJECT;
import static com.train.educate.happysever.net.ConnectConstants.MULTICAST_ERROR;
import static com.train.educate.happysever.net.ConnectConstants.ON_EXIT;
import static com.train.educate.happysever.net.ConnectConstants.ON_JOIN;
import static com.train.educate.happysever.net.ConnectConstants.SOCKET_NULL;
import static com.train.educate.happysever.net.ConnectConstants.UDP_DATA_ERROR;
import static com.train.educate.happysever.net.ConnectConstants.UDP_IP_ERROR;
import static com.train.educate.happysever.net.ConnectConstants.UDP_JOIN;
